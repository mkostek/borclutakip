...
namespace borcluMüsteriTakip
{
	partial class Form3
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Size = new System.Drawing.Size(485, 99);
			this.label1.TabIndex = 0;
			this.label1.Text = "Borçlu Takip Kayıt Sayfası";
			...
			this.label11.Text = "satisDanısmanı";
			// 
			// label12
			// 
			...
			this.label16.Text = "terminTarihi";
			// 
			// label17
			// 
			...
			this.label17.Text = "teslimTarihi";
			// 
			// dateTimePicker1
			// 
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(127, 655);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(254, 655);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(175, 42);
			this.button2.TabIndex = 20;
			this.button2.Text = "barkoddan Doldur";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.Button2Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(492, 655);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(268, 42);
			this.button3.TabIndex = 21;
			this.button3.Text = "koda Göre Doldur";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.Button3Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(835, 655);
			...
			// label18
			// 
			this.label18.Location = new System.Drawing.Point(598, 61);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(1034, 655);
			...
			this.ClientSize = new System.Drawing.Size(1826, 709);
